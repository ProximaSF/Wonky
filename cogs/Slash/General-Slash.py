...
Description:
This is a template to create your own discord client in python.
...
class RockPaperScissors(disnake.ui.Select):
    ...
    async def callback(self, interaction: disnake.MessageInteraction):
        ...
        client_choice = random.choice(list(choices.keys()))
        client_choice_index = choices[client_choice]
        ...
        if user_choice_index == client_choice_index:
            result_embed.description = f"**That's a draw!**\nYou've chosen {user_choice} and I've chosen {client_choice}."
...
class Fun(commands.Cog, name="fun-slash"):
    ...
    async def randomfact(self, interaction: ApplicationCommandInteraction) -> None:
        ...
        """
        # This will prevent your client from stopping everything when doing a web request - see: https://discordpy.readthedocs.io/en/stable/faq.html#how-do-i-make-a-web-request
    ...
    @commands.slash_command(name="rps", description="Play the rock paper scissors game against the client.")
    async def rock_paper_scissors(self, interaction: ApplicationCommandInteraction) -> None:
        """
        Play the rock paper scissors game against the client.
        :param interaction: The application command interaction.
        """
